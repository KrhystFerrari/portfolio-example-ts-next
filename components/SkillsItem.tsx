  ...
  return (
    <div className="mb-[4rem] md:mb-[8rem]">
      ...
      <p className="text-[#aaaaaa] font-normal w-[80%] text-[17px] opacity-80">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam nulla quis
        nisi aspernatur officiis vel minima impedit eveniet. Ratione illum
        sapiente facilis nostrum iusto deserunt ducimus inventore facere,
        laborum culpa.
      </p>
    </div>
  );
